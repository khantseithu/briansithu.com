...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Brian Sithu</title>
        <meta
          name="description"
          content="Explore the innovative world of an indie hacker, Brian Sithu, as he crafts feature-rich projects and weaves dreams into digital reality. From motivational coding journeys to whimsical adventures in creativity, discover a unique perspective on innovation and self-discovery."
        />
      </Head>
