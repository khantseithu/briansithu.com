...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Khant Si Thu</title>
        <meta
          name="description"
          content="Explore the innovative world of an indie hacker, Khant Si Thu, as he crafts feature-rich projects and weaves dreams into digital reality. From motivational coding journeys to whimsical adventures in creativity, discover a unique perspective on innovation and self-discovery."
        />
      </Head>
